...
namespace Junco\Database\Adapter\Pgsql;
...
class Adapter implements AdapterInterface
{
    ...
    public function __construct(array $config)
    {
        $this->connection = pg_connect(
            'host=' . $config['database.server'] . ' '
                ...
                . 'options=\'--client_encoding=' . $config['database.charset'] . '\' '
        );
    ...
    public function prepare(string $query): StatementInterface
    {
        ...
        return new AdapterStatement($this->connection, $stmt);
    }
    ...
    public function query(string $query): ResultInterface
    {
        ...
        return new AdapterResult($result);
    }
    ...
    {
        return \Junco\Database\Adapter\Pgsql\Schema\Schema::class;
    }
...
class AdapterStatement implements StatementInterface
{
     ...
     * Constructor
     */
    public function __construct(Connection $connection, Result $stmt)
    {
    ...
    {
        return new AdapterResult($this->result);
    }
