...
abstract class ForeignKeyBase implements ForeignKeyInterface
{
    /**
     * Constructor
     */
     ...
     * @return static
     */
    public function setDeleteRule(string $rule): static
    {
     ...
     * @return static
     */
    public function setUpdateRule(string $rule): static
    {
     ...
     * @return static
     */
    public function setReferencedColumn(string $table_name, string $column_name): static
    {
